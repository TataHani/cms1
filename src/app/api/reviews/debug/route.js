...
const reviewsResponse = await fetch(
  'https://mybusiness.googleapis.com/v4/accounts/' + business.google_account_id.replace('accounts/', '') + '/locations/' + business.google_location_id.replace('locations/', '') + '/reviews',
        {
